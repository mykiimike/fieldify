...
const ftURLStringify = async (data) => {
 ...
 */
const ftURL = {
    stringify: ftURLStringify, // Expose the ftURLStringify function as part of the ftURL module's public interface
    parse: ftURLParse, // Expose the ftURLVerify function as part of the ftURL module's public interface
