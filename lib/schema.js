...
class fieldifySchema {
    ...
    stringify(data) {
        return (this.input(data, {
            ...
            onAnalysis: async (data) => data.ctrl.type.stringify(data)
        }))
    }

    // Parses a string representation and returns the parsed data based on the schema.
    parse(data) {
        return (this.input(data, {
            rejectUnknown: false,
            rejectCast: false,
            rejectRequired: false,
            onAnalysis: async (data) => data.ctrl.type.parse(data)
        }))
    }
